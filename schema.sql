...
(1, 1, 'Luxury Villa Redesign', 'Complete interior transformation for high-end villas and luxury penthouses.', 'Our signature luxury villa design package includes 3D spatial mapping, custom material sourcing, lighting design, and end-to-end execution managed by certified architects.', 2500.00, 'per project', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80', 1),
(2, 2, 'Modern Corporate Office Workspace', 'Ergonomic, scalable workplace layouts designed to elevate productivity.', 'We design smart, collaboration-focused corporate environments equipped with acoustic paneling, glass partitions, and executive lounge suites.', 1800.00, 'per floor', 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80', 1),
(3, 3, '3D Architectural Rendering & Blueprinting', 'Ultra-realistic 4K walkthroughs and structural schematics.', 'Transform raw concepts into photorealistic 3D virtual walkthroughs before physical construction begins. Includes structural assessment and compliance checks.', 950.00, 'per design concept', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=800&q=80', 1),
(4, 4, 'Bespoke Custom Furniture Crafting', 'Custom handcrafted timber, marble, and velvet interior decor pieces.', 'Tailor-made furniture designed specifically for your space dimensions. Crafted using sustainable teak wood, brushed brass details, and luxury upholstery.', 1200.00, 'per package', 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80', 0);
