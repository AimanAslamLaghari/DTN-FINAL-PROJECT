...
# CDN Image Map for reliable cloud/serverless rendering
CDN_IMAGE_MAP = {
    'gallery1.jpg': 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80',
    'gallery2.jpg': 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80',
    'gallery3.jpg': 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80',
    'gallery4.jpg': 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=800&q=80',
    'service1.jpg': 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80',
    'service2.jpg': 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80',
    'service3.jpg': 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=800&q=80',
    'service4.jpg': 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80',
    'team1.jpg': 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80',
    'team2.jpg': 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80',
    'team3.jpg': 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80',
    'service_default.jpg': 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80',
    'gallery_default.jpg': 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=80',
    'team_default.jpg': 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80'
}

# Explicit static file route handler for serverless environments with CDN fallback
...
def custom_static(filename):
    ...
    # Automatic CDN image fallback if upload file is missing on serverless host
    basename = os.path.basename(filename)
    if basename in CDN_IMAGE_MAP:
        return redirect(CDN_IMAGE_MAP[basename])
    elif filename.startswith('uploads/'):
        return redirect('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80')
...
# Helper: Upload file helper (Serverless Base64 / Local Storage / URL support)
def save_uploaded_file(file_obj, default_path, custom_url=None):
    # 1. Direct URL provided
    if custom_url and custom_url.strip():
        return custom_url.strip()

    # 2. File uploaded from user computer
    if file_obj and hasattr(file_obj, 'filename') and file_obj.filename != '' and allowed_file(file_obj.filename):
        try:
            ...
            if img.mode in ('RGBA', 'P'):
                img = img.convert('RGB')
            # Downscale overly huge photography to HD standard (1000px max)
...
class Database:
    ...
    def _init_db(self):
        ...
        if engine == 'sqlite':
            ...
            if cursor.fetchone()[0] == 0:
                services = [
                    (1, 1, 'Luxury Villa Redesign', 'Complete interior transformation for high-end villas and luxury penthouses.', 'Our signature luxury villa design package includes 3D spatial mapping, custom material sourcing, lighting design, and end-to-end execution managed by certified architects.', 2500.0, 'per project', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80', 1),
                    (2, 2, 'Modern Corporate Office Workspace', 'Ergonomic, scalable workplace layouts designed to elevate productivity.', 'We design smart, collaboration-focused corporate environments equipped with acoustic paneling, glass partitions, and executive lounge suites.', 1800.0, 'per floor', 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80', 1),
                    (3, 3, '3D Architectural Rendering & Blueprinting', 'Ultra-realistic 4K walkthroughs and structural schematics.', 'Transform raw concepts into photorealistic 3D virtual walkthroughs before physical construction begins. Includes structural assessment and compliance checks.', 950.0, 'per design concept', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=800&q=80', 1),
                    (4, 4, 'Bespoke Custom Furniture Crafting', 'Custom handcrafted timber, marble, and velvet interior decor pieces.', 'Tailor-made furniture designed specifically for your space dimensions. Crafted using sustainable teak wood, brushed brass details, and luxury upholstery.', 1200.0, 'per package', 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80', 0)
                ]
            ...
            if cursor.fetchone()[0] == 0:
                gallery = [
                    (1, 1, 'The Emerald Penthouse Suite', 'Downtown Skyline', 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=80', 'Modern minimalist living room featuring floor-to-ceiling glass windows and custom marble hearth.'),
                    (2, 2, 'Horizon Tech Innovation Hub', 'Tech City Block', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80', 'Open-concept co-working ecosystem featuring bio-centric green walls and custom acoustic pods.'),
                    (3, 1, 'Nordic Minimalist Villa', 'Suburban Estates', 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80', 'Warm neutral color palettes, natural oak flooring, and custom ambient cove lighting.'),
                    (4, 3, 'Skyline Glass Pavilion Architecture', 'Coastal Heights', 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=800&q=80', 'Futuristic architectural extension integrating passive solar cooling and smart home automation.')
                ]
            ...
            if cursor.fetchone()[0] == 0:
                team = [
                    (1, 'Eleanor Vance', 'Principal Architectural Director', 'Over 12 years of experience leading international luxury interior and spatial planning projects.', 'eleanor@luxecraft.com', '+1 (555) 234-5678', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80', 1),
                    (2, 'Marcus Thorne', 'Senior Commercial Space Designer', 'Specializes in ergonomic corporate office design, sustainable acoustic materials, and spatial flow.', 'marcus@luxecraft.com', '+1 (555) 345-6789', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80', 2),
                    (3, 'Sophia Al-Mansoor', '3D Visualizer & Color Theorist', 'Award-winning CG artist delivering photorealistic 3D architectural renders and lighting concepts.', 'sophia@luxecraft.com', '+1 (555) 456-7890', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80', 3)
                ]
                cursor.executemany("INSERT INTO team_members VALUES (?, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)", team)
                conn.commit()

            # Automatic update of image URLs to unique 4K CDN photos if local paths are present
            img_updates = [
                ("UPDATE services SET image_url = 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80' WHERE id = 1 AND (image_url LIKE '%service1%' OR image_url LIKE '%service_default%')", ()),
                ("UPDATE services SET image_url = 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80' WHERE id = 2 AND (image_url LIKE '%service2%' OR image_url LIKE '%service_default%')", ()),
                ("UPDATE services SET image_url = 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=800&q=80' WHERE id = 3 AND (image_url LIKE '%service3%' OR image_url LIKE '%service_default%')", ()),
                ("UPDATE services SET image_url = 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80' WHERE id = 4 AND (image_url LIKE '%service4%' OR image_url LIKE '%service_default%')", ()),
                ("UPDATE gallery SET image_url = 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=80' WHERE id = 1 AND (image_url LIKE '%gallery1%' OR image_url LIKE '%gallery_default%')", ()),
                ("UPDATE gallery SET image_url = 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80' WHERE id = 2 AND (image_url LIKE '%gallery2%' OR image_url LIKE '%gallery_default%')", ()),
                ("UPDATE gallery SET image_url = 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80' WHERE id = 3 AND (image_url LIKE '%gallery3%' OR image_url LIKE '%gallery_default%')", ()),
                ("UPDATE gallery SET image_url = 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=800&q=80' WHERE id = 4 AND (image_url LIKE '%gallery4%' OR image_url LIKE '%gallery_default%')", ()),
                ("UPDATE team_members SET image_url = 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80' WHERE id = 1 AND (image_url LIKE '%team1%' OR image_url LIKE '%team_default%')", ()),
                ("UPDATE team_members SET image_url = 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80' WHERE id = 2 AND (image_url LIKE '%team2%' OR image_url LIKE '%team_default%')", ()),
                ("UPDATE team_members SET image_url = 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80' WHERE id = 3 AND (image_url LIKE '%team3%' OR image_url LIKE '%team_default%')", ()),
            ]
            for sql, p in img_updates:
                try:
...
def admin_service_add():
    ...
    image_url = save_uploaded_file(image_file, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80', request.form.get('image_url'))
...
def admin_service_edit(service_id):
    ...
    image_file = request.files.get('image')
    image_url = save_uploaded_file(image_file, service['image_url'], request.form.get('image_url'))
...
def admin_gallery_add():
    ...
    image_file = request.files.get('image')
    image_url = save_uploaded_file(image_file, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=80', request.form.get('image_url'))
...
def admin_team_add():
    ...
    image_file = request.files.get('image')
    image_url = save_uploaded_file(image_file, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80', request.form.get('image_url'))
...
def admin_team_edit(member_id):
    ...
    image_file = request.files.get('image')
    image_url = save_uploaded_file(image_file, member['image_url'], request.form.get('image_url'))
